...
export const MAIN_KEYBOARD = new InlineKeyboard().text(FORECAST_CONVERSATION, FORECAST_CONVERSATION_ID).row().text(ANALYZE_CONVERSATION, ANALYZE_CONVERSATION_ID).row().text(QUESTION_CONVERSATION, QUESTION_CONVERSATION_ID).row().text(CHANGE_SETTINGS_CONVERSATION, CHANGE_SETTINGS_CONVERSATION_ID).row().text(PSYCHO_CONVERSATION, PSYCHO_CONVERSATION_ID)
