...
export const MAIN_KEYBOARD = new InlineKeyboard().text(FORECAST_CONVERSATION, FORECAST_CONVERSATION_ID).text(ANALYZE_CONVERSATION, ANALYZE_CONVERSATION_ID).text(QUESTION_CONVERSATION, QUESTION_CONVERSATION_ID).row().text(CHANGE_SETTINGS_CONVERSATION, CHANGE_SETTINGS_CONVERSATION_ID)
