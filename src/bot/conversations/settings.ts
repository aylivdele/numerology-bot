...
export async function changeSettingsConversation(conversation: Conversation<Context, Context>, ctx: Context, message_id?: number) {
...
export async function settingsConversation(conversation: Conversation<Context, Context>, ctx: Context, message_id?: number) {
  if (message_id) {
...
export async function interestsSettingsConversation(conversation: Conversation<Context, Context>, ctx: Context, message_id?: number) {
...
export async function formatSettingsConversation(conversation: Conversation<Context, Context>, ctx: Context, message_id?: number) {
